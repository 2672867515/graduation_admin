...
const Used=(props)=> {
  ...
  const add=()=>{
    ...
    form.setFieldValue('bedroomeqs', "null");
    form.setFieldValue('publiceqs', "null");
  }
  ...
  const doedit=(r)=>{
    setActiveKey("1")
    console.log(r);
    setCheckedList3(r.bedroomeqs.slice(','))
    setCheckedList4(r.publiceqs.slice(','))
    const data={...r,ishot:r.ishot==='true'?true:false}
    Object.keys(data).forEach(key => {
      form2.setFieldValue(key, data[key]);
    });
    form2.setFieldValue('bedroomeqs', r.bedroomeqs.slice(','));
    form2.setFieldValue('publiceqs', r.publiceqs.slice(','));
  ...
  const CheckboxonChange = (list: CheckboxValueType[]) => {
    console.log(list);
    setCheckedList(list);
    form.setFieldValue('bedroomeqs',list.toString())
    
  };
  const CheckboxonChange2 = (list: CheckboxValueType[]) => {
    console.log(checkedList2);
    setCheckedList2(list);
    form.setFieldValue('publiceqs',list.toString())
  };
  const CheckboxonChange3 = (list: CheckboxValueType[]) => {
    console.log(list);
    setCheckedList3(list);
    form2.setFieldValue('bedroomeqs',list.toString())
    
  };
  const CheckboxonChange4 = (list: CheckboxValueType[]) => {
    setCheckedList4(list);
    console.log(list);
    
    form2.setFieldValue('publiceqs',list.toString())
  };
        ...
        >
          <Form.Item
            ...
            <Form.Item
              ...
              name="bedroomeqs"
            >
              <Checkbox.Group options={plainOptions} value={checkedList} onChange={CheckboxonChange} />       
           </Form.Item>
            <Form.Item
              label="公共设施"
              name="publiceqs"
            >
              <Checkbox.Group options={plainOptions2} value={checkedList2} onChange={CheckboxonChange2} />     
             </Form.Item>
        </Form>
      </Modal>
      <Modal 
        ...
        <Tabs defaultActiveKey="1" activeKey={activeKey} onChange={tabshandleChange}>
          ...
          >
            ...
            <Form.Item
              ...
              name="bedroomeqs"
            >
              <Checkbox.Group options={plainOptions} value={checkedList3} onChange={CheckboxonChange3} />       
           </Form.Item>
            <Form.Item
              label="公共设施"
              name="publiceqs"
            >
              <Checkbox.Group options={plainOptions2} value={checkedList4} onChange={CheckboxonChange4} />     
             </Form.Item>
